package com.cubedao.wallet.contracts.wrappers.polygon;
...
/**
 * Contract wrapper for ERC20 NFT Worlds CBIT token on the Polygon chain.
 * Auto-generated with web3j version 4.1.1
 */

@SuppressWarnings("rawtypes")
public class PolygonCBITToken extends Contract {
    ...
    @Deprecated
    protected PolygonCBITToken(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected PolygonCBITToken(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider);
    }

    @Deprecated
    protected PolygonCBITToken(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    protected PolygonCBITToken(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    @Deprecated
    public static PolygonCBITToken load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new PolygonCBITToken(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static PolygonCBITToken load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new PolygonCBITToken(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static PolygonCBITToken load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new PolygonCBITToken(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static PolygonCBITToken load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new PolygonCBITToken(contractAddress, web3j, transactionManager, contractGasProvider);
    }
